...
export default {
  ...
  methods: {
    ...
    onMouseMove(event) {
      ...
      if (this.positionX <= -1400 && offsetX < 0) {
        this.positionX -= offsetX;
...
@font-face {
  font-family: "one";
  src: url("../assets/VectrexWeb-Bold.woff2") format("woff");
}
...
.roadmap-hexagon1::after {
  width: 100%;
  height: 100%;
  background: rgba(232, 90, 67);
  top: 0;
  left: 0;
  transform: scale(0.7);
  content: "";
...
.ytwo {
  width: 63.5%;
  margin: 0 auto;
  padding: 8.375rem 5rem 6.25rem 8.25rem;
  box-sizing: border-box;
  column-gap: 6rem;
  align-items: center;
