...
onMounted(() => {
  ...
  if (localStorage.getItem("user")) {
    ...
    console.log("userlog", userlog.value);
    tasklis();
  }
...
.yaritabright {
  ...
  background-image: url("https://www.ethratio.io/static/media/dotted-calculator.3fbea5e1d69fd5b29618514bd7802a19.svg");
